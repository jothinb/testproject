...
require.config({
	...
	paths: {
		...
		lodash: 'empty:',
		three: 'empty:',
		'orbit-controls': 'empty:',
		'map-controls': 'empty:',
		'three-projector': 'empty:',
		'three-svg-renderer': 'empty:',
		'three-octree': 'empty:',
		'd3-threeD': 'empty:',
		stats: 'empty:',
		tween: 'empty:',
