...
/**
 * I am the utilties class of VRuntime
 */
...
define('base-class',['require'],function (require) {
     ...
     *
     * BaseClass is the root Class of all VRuntime class.
     *
     ...
     *
     * ```
     * //Create another class by extending from BaseClass
     ...
     * });
     *
     * //MyExtendedClass extends from ExtendedClass
     * var MyExtendedClass = ExtendedClass.extend({
     *  //my extend class constructor
     *  init: function(){
     *      //call super class constructor here
     *      this._super()
     *  }
     *
     * });
...
define('logger',[],function () {
	 ...
	 *
     * @namespace VRuntime.logger
     * @module VRuntime
     * @submodule logger
     * @class Logger
	 * @example
	 * ```
	 var logger = VRuntime.logger.create('MyApp');
	...
	var Logger = (function () {
		 ...
		 * @example
		 * var logger = VRuntime.logger.create('category');
...
define('v-logger-service',['logger', 'utils'], function(Logger, Utils){
	...
	*/
    ...
    /**
     * I return a logger instance by category name
     * @method getInstance
     * @param category String The category of the log to be shown in console
     * @example
     * ```
     *  var logger = VRuntime.logger.getInstance('myApp');
     *
     * ```
     */
    ...
    /**
     * I am the VRuntime logger
     * @namespace VRuntime
     * @module VRuntime
     * @submodule logger
     * @class logger
     * @type {{create: Function, getInstance: Function}}
     */
	return {
		create: create,
		...
		*/
		...
		transformSettingsAttrToURLParamsObj: function (settingsAttributes) {
			...
			if (settingsAttributes)
				for (var key in settingsAttributes) {
					urlParamsObj.hasOwnProperty(key) || (urlParamsObj[key] = []);
					if(settingsAttributes[key] instanceof Array) {
						Array.prototype.push.apply(urlParamsObj[key], settingsAttributes[key]);
					}else {
		...
		transformSettingsAttrToURLParams: function (settingsAttributes) {
			...
			if (urlParamsObj) {
				for (var key in urlParamsObj) {
					if(urlParamsObj[key] instanceof Array){
						for(var param in urlParamsObj[key]){
							urlParams += key + '=' + urlParamsObj[key][param] + '&';
						}
					}else{
...
define('v-datasource-service',[ 'services/base-rest-data-service', 'services/proxy-data-service', 'services/realtime-data-service', 'utils' ], function(DataService, ProxyDataService, ProxyRealtimeDataService, Utils) {
    ...
    */
    ...
    /**
     * I will return datasource instance.  This method is deprecated, please use getInstance instead.
     * @example
     * ```
    ...
    /**
     * I am the VRuntime datasource class
     * @namespace VRuntime
     * @module VRuntime
     * @submodule datasource
     * @class datasource
     * @type {{create: Function, get: Function, getInstance: Function, destroy: Function, destroyAll: Function}}
     */
...
define('views/base-view',['require', 'knockout', 'jquery', 'base-class'], function (require, ko, $, BaseClass) {
	...
	/**
	 * I am the BaseView of all views used in workbench
	 *
     * @namespace VRuntime
     * @class BaseView
     * @module VRuntime
...
define('views/base-directive',['require', 'base-class'], function (require, BaseClass) {
    ...
    /**
     * This is the Base Directive class.
     *
     * It is a template of Angular Directive Definition Object https://docs.angularjs.org/api/ng/service/$compile#directive-definition-object
     *
     * This defines the blue print of Predix Directive Widget
     * @namespace VRuntime.widget
     * @class BaseDirective
     * @module VRuntime
     * @submodule widget
    ...
    var BaseDirective = BaseClass.extend({
        /**
         * This directive restict property
         *
         * String of subset of EACM which restricts the directive to a specific directive declaration style.
         * restrict is set to E - Element name (default): <my-directive></my-directive>
         * @property restrict
         * @type {String}
         * @default E
         */
        restrict: 'E',
        /**
         * This directive replace property
         *
        ...
        replace: true,
        /**
         * This directive scope property, it is set to be isolated scope.
         *
        ...
        /**
         * vLink is the method invoked by directive link method. VRuntime add vLink to the BaseDirective because we would like to inject some logic in the linking phase of the directive before your main link logic is invoked.
         * One example is to register the scope.$on('$destroy', fn) handler.
         *
         * vLink has identical functionality as the link function. The link function is responsible for registering DOM listeners as well as updating the DOM. It is executed after the template has been cloned. This is where most of the directive logic will be put.
         *
         * @method vLink
         * @param scope
         * @param element
         ...
         * @example
         * ```
         * var MyDirective = VRuntime.widget.BaseDirective.extend({
         *      scope: {
         *          greeting: '='
         *      },
         *      template: '<div>{{greeting}}</div>',
         *      vLink(scope, element, attrs){
         *      ...
         *      }
         * });
         *
         ...
         * });
         *
         * //Html markup on the page template
         * //<my-directive data-greeting='{{greeting}}'></my-directive>
         *
         * ```
         */
        ...
        /**
         * vDestroy method is a callback invoked when directive scope is destroyed
         * vDestroy is the callback function (callbackFn) of scope.$on('$destroy', callbackFn); It will turn off all event listener registered to the dom of the directive.
         * @method vDestroy
         * @param scope
         * @example
         * ```
...
define('v-widget-service',['jquery', 'utils', 'v-binder-service', 'views/base-widget', 'views/base-directive'], function ($, Utils, binderService, BaseWidget, BaseDirective) {
	...
	/**
     * I retrieve a widget instance with the given id. This method is deprecated, please use getInstance instead.
     * 
     * @example
     * ```
...
define('v-runtime',['v-widget-service', 'v-binder-service', 'v-datasource-service', 'utils', 'postal', 'v-logger-service', 'v-i18n-service', 'base-class', 'views/base-view', 'knockout', 'v-angular/main'], function (WidgetService, BinderService, DataSourceService, Utils, postal, LoggerService, i18nService, BaseClass, BaseView, ko) {
	...
	/**
	 * VRuntime object in window namespace is the entry point to access the following VRuntime classes and methods.
     * @namespace window
     * @module VRuntime
     * @main VRuntime
	 */
	var vruntime = {
		...
		/**
		 * I am a reference to the postal library. https://github.com/postaljs/postal.js/
		 * @namespace VRuntime
		 * @module VRuntime
		 * @class postal
		...
		BaseClass: BaseClass,
        /**
         * I am a reference to the BaseView class.
         * @namspace VRuntime
         * @module VRuntime
         */
        BaseView: BaseView
