define(['angular', 'bower_components/px-contextual-dashboard/services/spec/unit/mockObjects', 'angular-mocks'], function(angular, mockObjects) {
    ...
    describe('The Px-Tree-Nav', function() {

        describe('when initialized with arguments', function() {

            var scope, PxTreeNavController, q, defer, rootScope;
            ...
            beforeEach(inject(function ($controller, $rootScope, $q) {
                ...
                PxTreeNavController = $controller('PxTreeNavController', {
                    $scope: scope
                });
                scope.$apply();
            }));
            ...
            describe('when a context is clicked', function() {
                ...
                describe('when a 2nd context is clicked', function() {
                    ...
                    beforeEach(function () {
                        ...
                        scope.handlers.isOpenable = function(something) {
                            return false;
                        };
                    ...
                    describe('when click back in the tree to a different 2nd level element (Brakes) and children are slow to resolve', function() {
                        ...
                        it("will clear the children of the new selected node so they don't linger", function() {
                            expect(scope.displayNodes.length).toBe(2);
                            expect(scope.displayNodes[0].children.length).toBe(3);
                            expect(scope.displayNodes[0].children[0][scope.labelField]).toBe("Mustang");
                            expect(scope.displayNodes[0].children[1][scope.labelField]).toBe("Sandy");
        ...
        describe('with alternate arguments', function() {
            var scope, PxTreeNavController, rootScope, q, defer;
            ...
            describe('when a context is clicked', function () {
                ...
                beforeEach(function () {
                    scope.handlers.itemClickHandler = function(indx) {};
